...
public class PoliceActivity extends AppCompatActivity implements UpdateRecyclerView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item.add(new StaticRvModel(R.drawable.congan3, "Trung Quốc"));
        item.add(new StaticRvModel(R.drawable.congan2, "Mỹ"));
        item.add(new StaticRvModel(R.drawable.congan1, "Anh"));
